<script lang="ts">
    import type {AnimationBuilder,ActionSheetButton} from '@ionic/core';
 ...
 //@ts-ignore
   export let buttons: (ActionSheetButton | string)[] = [];
 //@ts-ignore
 ...
 //@ts-ignore
   export let htmlAttributes: ActionSheetAttributes = undefined;
...
on:click><slot/> </ion-action-sheet>
