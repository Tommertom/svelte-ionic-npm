<script lang="ts">
    import type {AnimationBuilder,IonicSafeString,AlertButton,AlertInput,AlertAttributes} from '@ionic/core';
 ...
 //@ts-ignore
   export let message: string | IonicSafeString = undefined;
 //@ts-ignore
   export let buttons: (AlertButton | string)[] = [];
 //@ts-ignore
 ...
 //@ts-ignore
   export let htmlAttributes: AlertAttributes = undefined;
