<script lang="ts">
 ...
 //@ts-ignore
   export let detail: boolean = undefined;
 //@ts-ignore
 ...
 //@ts-ignore
   export let fill: 'outline' | 'solid' = undefined;
 //@ts-ignore
 ...
 //@ts-ignore
   export let counterFormatter: CounterFormatter = undefined;
...
on:click><slot/><slot name='start'/><slot name='end'/><slot name='error'/><slot name='helper'/> </ion-item>
