...
declare global {
  ...
  namespace svelteHTML {
    ...
    interface IonAccordion extends EventTarget {
    ...
    interface IonAccordionGroup extends EventTarget {
    ...
    interface IonActionSheet extends EventTarget {
    ...
    interface IonAlert extends EventTarget {
    ...
    interface IonApp extends EventTarget {

    }

    interface IonAvatar extends EventTarget {

    }

    interface IonBackButton extends EventTarget {
    ...
    interface IonBackdrop extends EventTarget {
    ...
    interface IonBadge extends EventTarget {
    ...
    interface IonBreadcrumb extends EventTarget {
    ...
    interface IonBreadcrumbs extends EventTarget {
    ...
    interface IonButton extends EventTarget {
    ...
    interface IonButtons extends EventTarget {
    ...
    interface IonCard extends EventTarget {
    ...
    interface IonCardContent extends EventTarget {
    ...
    interface IonCardHeader extends EventTarget {
    ...
    interface IonCardSubtitle extends EventTarget {
    ...
    interface IonCardTitle extends EventTarget {
    ...
    interface IonCheckbox extends EventTarget {
    ...
    interface IonChip extends EventTarget {
    ...
    interface IonCol extends EventTarget {
    ...
    interface IonContent extends EventTarget {
    ...
    interface IonDatetime extends EventTarget {
    ...
    interface IonDatetimeButton extends EventTarget {
    ...
    interface IonFab extends EventTarget {
    ...
    interface IonFabButton extends EventTarget {
    ...
    interface IonFabList extends EventTarget {
    ...
    interface IonFooter extends EventTarget {
    ...
    interface IonGrid extends EventTarget {
    ...
    interface IonHeader extends EventTarget {
    ...
    interface IonImg extends EventTarget {
    ...
    interface IonInfiniteScroll extends EventTarget {
    ...
    interface IonInfiniteScrollContent extends EventTarget {
    ...
    interface IonInput extends EventTarget {
    ...
    interface IonItem extends EventTarget {
    ...
    interface IonItemDivider extends EventTarget {
    ...
    interface IonItemGroup extends EventTarget {

    }

    interface IonItemOption extends EventTarget {
    ...
    interface IonItemOptions extends EventTarget {
    ...
    interface IonItemSliding extends EventTarget {
    ...
    interface IonLabel extends EventTarget {
    ...
    interface IonList extends EventTarget {
    ...
    interface IonListHeader extends EventTarget {
    ...
    interface IonLoading extends EventTarget {
    ...
    interface IonMenu extends EventTarget {
    ...
    interface IonMenuButton extends EventTarget {
    ...
    interface IonMenuToggle extends EventTarget {
    ...
    interface IonModal extends EventTarget {
    ...
    interface IonNav extends EventTarget {
    ...
    interface IonNavLink extends EventTarget {
    ...
    interface IonNote extends EventTarget {
    ...
    interface IonPicker extends EventTarget {
    ...
    interface IonPopover extends EventTarget {
    ...
    interface IonProgressBar extends EventTarget {
    ...
    interface IonRadio extends EventTarget {
    ...
    interface IonRadioGroup extends EventTarget {
    ...
    interface IonRange extends EventTarget {
    ...
    interface IonRefresher extends EventTarget {
    ...
    interface IonRefresherContent extends EventTarget {
    ...
    interface IonReorder extends EventTarget {

    }

    interface IonReorderGroup extends EventTarget {
    ...
    interface IonRippleEffect extends EventTarget {
    ...
    interface IonRoute extends EventTarget {
    ...
    interface IonRouteRedirect extends EventTarget {
    ...
    interface IonRouter extends EventTarget {
    ...
    interface IonRouterLink extends EventTarget {
    ...
    interface IonRouterOutlet extends EventTarget {
    ...
    interface IonRow extends EventTarget {

    }

    interface IonSearchbar extends EventTarget {
    ...
    interface IonSegment extends EventTarget {
    ...
    interface IonSegmentButton extends EventTarget {
    ...
    interface IonSelect extends EventTarget {
    ...
    interface IonSelectOption extends EventTarget {
    ...
    interface IonSkeletonText extends EventTarget {
    ...
    interface IonSlide extends EventTarget {

    }

    interface IonSlides extends EventTarget {
    ...
    interface IonSpinner extends EventTarget {
    ...
    interface IonSplitPane extends EventTarget {
    ...
    interface IonTab extends EventTarget {
    ...
    interface IonTabBar extends EventTarget {
    ...
    interface IonTabButton extends EventTarget {
    ...
    interface IonTabs extends EventTarget {
    ...
    interface IonText extends EventTarget {
    ...
    interface IonTextarea extends EventTarget {
    ...
    interface IonThumbnail extends EventTarget {

    }

    interface IonTitle extends EventTarget {
    ...
    interface IonToast extends EventTarget {
    ...
    interface IonToggle extends EventTarget {
    ...
    interface IonToolbar extends EventTarget {
    ...
    interface IonVirtualScroll extends EventTarget {
